...
Namespace ExchangeSystem
	Public Class MyMergedCell
		...
		Public Sub New(ByVal rowHandle As Integer, ByVal col1 As GridColumn, ByVal col2 As GridColumn, ByVal col3 As GridColumn)
		...
		Private _Column3 As GridColumn
		...
		Public Property Column3() As GridColumn
			Get
				Return _Column3
			End Get
			Set(ByVal value As GridColumn)
