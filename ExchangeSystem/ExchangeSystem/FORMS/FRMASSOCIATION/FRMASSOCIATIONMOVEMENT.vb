...
Public Class FRMASSOCIATIONMOVEMENT
    Public Sub lodePreportes()
        Dim dt As New DataTable
        dt.Clear()

        dt = SElectUEserFormButtn(97, UserID)
    ...
    Sub LOADDATA()
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("AssActivityTb_GETASSO", PRM)
        If DT.Rows.Count > 0 Then
            GVRole.Columns.Clear()
    ...
    Private Sub SimpleButton11_Click(sender As Object, e As EventArgs) Handles SimpleButton11.Click
        ...
        Dim dt As DataTable = RUN_QUARY_PRO("ZRPT_AssActivityTb_GETASSO", prm)
        If dt.Rows.Count > 0 Then
            Dim report As New RPTASSOCIATIONMOVEMENT
