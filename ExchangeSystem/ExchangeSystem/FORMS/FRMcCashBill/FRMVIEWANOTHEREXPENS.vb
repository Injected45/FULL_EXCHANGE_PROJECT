...
Public Class FRMVIEWANOTHEREXPENS
    Public Sub LoadData()
        ...
        DT.Clear()
        DT = RUN_QUARY_PRO("[ANOTHEREXPENSTB_LOADTODVG]", PR)
    ...
    Private Sub GVRole_Click(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            FRMANOTHEREXPENS.IsUpdate = True
            FRMANOTHEREXPENS.SHOW_EMCUSCODE(CO)
            FRMANOTHEREXPENS.BtnSave.Enabled = False
            'FRMANOTHEREXPENS.BtnPrint.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMANOTHEREXPENS.BtnDelete.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMANOTHEREXPENS.BtnEdit.Enabled = True
            FRMANOTHEREXPENS.BtnPrint.Enabled = True
            FRMANOTHEREXPENS.DISAPLEDCONTROLS()
            FRMANOTHEREXPENS.BtnEdit.Caption = "استرجاع القيمة"
        End If
        Me.Close()
    End Sub
