Public Class FRMOWNCURRENCYPRICEDETAILS
    Public frm = New FRMOUSRCURRENCYPRICEDTTELSS
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        'frm = New FRMOUSRCURRENCYPRICEDTTELSS
        'FRMOWNUSRCURRENCYPRICEDTTELSS.Dock = DockStyle.Fill
        'PanelControl3.Controls.Clear()
        'PanelControl3.Controls.Add(frm)
        FRMOWNUSRCURRENCYPRICEDTTELSS.LOADCIDFROM(1)
        Timer1.Start()
    End Sub
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        'PanelControl3.Controls.Clear()
        'PanelControl3.Controls.Add(frm)
        FRMOWNUSRCURRENCYPRICEDTTELSS.LOADCIDFROM(2)
    End Sub
    ...
    Private Sub PrintBTN_Click(sender As Object, e As EventArgs) Handles PrintBTN.Click
        FRMOWNUSRCURRENCYPRICEDTTELSS.printRPT()
    End Sub
