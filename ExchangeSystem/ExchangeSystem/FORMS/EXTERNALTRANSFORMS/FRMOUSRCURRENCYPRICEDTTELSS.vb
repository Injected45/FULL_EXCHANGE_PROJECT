...
Public Class FRMOUSRCURRENCYPRICEDTTELSS
    ...
    Public Sub LOADCIDFROM(IDTYPE As Integer)
        ...
        Catch ex As Exception
            ErrorMessageUC(Me, "رسالة خطا", ex.Message)
        End Try
    End Sub
    ...
    Private Sub RepositoryItemButtonEdit1_DoubleClick(sender As Object, e As EventArgs) Handles RepositoryItemButtonEdit1.DoubleClick
        FRMBTNEDITSH.CurrencyPricCatogre(GVRole.GetFocusedRowCellValue("IDCruns"), GVRole.GetFocusedRowCellValue("Typesd"), 2)
    End Sub
