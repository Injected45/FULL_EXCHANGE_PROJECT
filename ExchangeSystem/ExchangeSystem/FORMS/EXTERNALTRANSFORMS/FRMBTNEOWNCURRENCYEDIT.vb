...
Public Class FRMBTNEOWNCURRENCYEDIT
    ...
    Private Sub ACCTO_KeyPress(sender As Object, e As KeyPressEventArgs) Handles CurrencyIDTo.KeyPress
        e.Handled = True
    End Sub
    Private Sub TextEdit2_KeyPress(sender As Object, e As KeyPressEventArgs)
        e.Handled = True
    End Sub
    ...
    Public Sub CurrencyPricCatogreUpdate()
        Try
            ...
            If XtraMessageBox.Show(lookAndFeelError, "هل تريد تعديل الأسعار بالفعل؟", "رسالة معلومات", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then
                ...
                'FRMNEWCURRENCYETAILS.LOADATA(prm(6).Value, FRMNEWCURRENCYETAILS.AccountType.SelectedIndex, FRMNEWCURRENCYETAILS.BranchID.EditValue, FRMNEWCURRENCYETAILS.CountryID.EditValue, FRMNEWCURRENCYETAILS.BankID.EditValue, FRMNEWCURRENCYETAILS.PriceType.SelectedIndex)
