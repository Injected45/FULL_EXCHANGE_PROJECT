...
Public Class FRMINTCURSALES
    Dim IDcod As ULong, msgST As Int16
    Public Sub lodePreportes()
        Dim dt As New DataTable
        dt.Clear()
        dt = SElectUEserFormButtn(34, UserID)
    ...
    Sub LOADSafeID2(NGridLookUpEdit As GridLookUpEdit, UserID As Integer, UESERTYPE As Integer, BRnchID As Integer, Type As ULong)
        Try
            ...
            Dim dt As New DataTable
            dt.Clear()
            dt = RUN_QUARY_PRO("SafeID_LODE2", PR)
            If dt.Rows.Count > 0 Then
                NGridLookUpEdit.Properties.DataSource = dt
                NGridLookUpEdit.Properties.ValueMember = "AccID"
                NGridLookUpEdit.Properties.DisplayMember = "AccName"
    ...
    Public Sub get_BracuNetBurnnc()
        Try
            ...
            Dim dt As New DataTable
            dt.Clear()
            dt = RUN_QUARY_PRO("get_BracuNetBurnnc", prm)
    ...
    Public Sub CurrenciesBuyandsellTB_Insert()
        Try
            ...
            RUN_EXUTE_PRO("CurrenciesBuyandsellTB_Insert", prm)
            msgST = prm(10).Value
            If prm(10).Value = 0 Or prm(10).Value = 2 Then
                ...
                Return
            Else
                FRMIViewNTCURSALES.IsBuyORSale = 1
                Print()
                BtnNew.PerformClick()
            End If
        Catch ex As Exception
    ...
    Public Overrides Sub SetData()
        ...
        If TextEdit1.EditValue = String.Empty Then
            ...
            Return
        End If
        If SAFTypeform.EditValue = 0 And SafTypeTo.EditValue = 0 Then
    ...
    Private Sub BPrice2_EditValueChanged(sender As Object, e As EventArgs) Handles BPrice2.EditValueChanged
        ...
        'LabelControl1.Text = "المبلغ بالحروف " & Space(1) & ":" & arC.numtolit(Val(BPrice2.EditValue), 3, CurrencyTo.Text, "", True, True)
    ...
    Private Sub SAFTypeform_EditValueChanged(sender As Object, e As EventArgs) Handles SAFTypeform.EditValueChanged
        If SAFTypeform.EditValue > -1 And SAFTypeform.Text <> String.Empty Then
            SafeID.Properties.DataSource = Nothing
            LOADSafeID2(SafeID, UserID, GProfIDLog, BranchID.EditValue, SAFTypeform.EditValue)
    ...
    Sub GetRecord(x)
        ...
        If dt.Rows.Count > 0 Then
            ...
            CurrenciesBuyandsellTB_Update_GET_Vluae()
            LOADSafeID(SAFFACCTO, UserID, GProfIDLog, BranchID.EditValue, SafTypeTo.EditValue)
    ...
    Public Overrides Sub Print()
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                        ...
                        'If FRMIViewNTCURSALES.IsBuyORSale = 1 Then
    ...
    Public Sub CurrenciesBuyandsellTB_Update_GET_Vluae()
        Try
