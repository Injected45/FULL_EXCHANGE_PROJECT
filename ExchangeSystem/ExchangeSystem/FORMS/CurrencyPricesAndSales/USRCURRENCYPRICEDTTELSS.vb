...
Public Class USRCURRENCYPRICEDTTELSS
    Public C, t As Integer
    Public Sub LOADCIDFROM(IDTYPE As Integer)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "رسالة خطا", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End Try
    End Sub
    ...
    Public Sub LOADATA(CurrencyIDFrom As Integer, typeMSGN As Integer)
        Try
            ...
            dt = RUN_QUARY_PRO("CurrencyPriceDetailsTb_Grid", prm)
            If dt.Rows.Count > 0 Then
    ...
    Private Sub RepositoryItemButtonEdit1_DoubleClick(sender As Object, e As EventArgs) Handles RepositoryItemButtonEdit1.DoubleClick
        FRMBTNEDITSH.CurrencyPricCatogre(GVRole.GetFocusedRowCellValue("IDCruns"), GVRole.GetFocusedRowCellValue("Typesd"), 1)
    End Sub
    Public Sub printRPT()
        ...
        Try
            ...
            PRM(3) = New SqlParameter("@TypeID", 1)
