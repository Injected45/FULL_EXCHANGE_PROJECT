...
Public Class Association_revenues
    Sub NEWRECORD()
    ...
    Sub LOADDATA()
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("Association_revenues", PRM)
        If DT.Rows.Count > 0 Then
            GVRole.Columns.Clear()
    ...
    Private Sub SimpleButton11_Click(sender As Object, e As EventArgs) Handles SimpleButton11.Click
        ...
        Dim dt As DataTable = RUN_QUARY_PRO("ZRPTAssociation_revenues", PRM)
        dt.TableName = "AssActivityTb"
        Dim ds As New DataSet
        ds.Tables.Add(dt)
        If dt.Rows.Count > 0 Then
            Dim report As New RPT_Revenuesfor_associations
