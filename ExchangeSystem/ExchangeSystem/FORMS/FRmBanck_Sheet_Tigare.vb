...
Public Class FRmBanck_Sheet_Tigare

    Private Sub FRmBanck_Sheet_Tigare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "Insert Data"
    Public Function Banck_Sheet_Tigare_insertttYPE() As DataTable
        ...
        dt.Clear()
        dt.Columns.Add("inserdate")
        dt.Columns.Add("Exret")
        dt.Columns.Add("Notes")
        dt.Columns.Add("code")
        dt.Columns.Add("ACCAcount")
        dt.Columns.Add("UeserImort")
        If GridView1.RowCount > 0 Then
            For i = 0 To GridView1.RowCount - 1
                dt.Rows.Add(Convert.ToDateTime(GridView1.GetRowCellValue(i, "insertdate")), GridView1.GetRowCellValue(i, "rate"), GridView1.GetRowCellValue(i, "note"),
                            GridView1.GetRowCellValue(i, "code"), GridView1.GetRowCellValue(i, "accaccount"), UserID)
            Next
        End If
        Return dt
    End Function
    ...
    Public Sub Banck_Sheet_Tigare_insert()
        Try
            ...
            RUN_EXUTE_PRO("Banck_Sheet_Tigare_insert", PRM)
            SplashScreenManager1.CloseWaitForm()
