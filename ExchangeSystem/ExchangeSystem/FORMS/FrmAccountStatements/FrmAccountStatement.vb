...
Public Class FrmAccountStatement
    ...
    Sub LoadData()
        ...
        If AccID.EditValue = -1 Then
            AccID.ErrorText = "يجب اختيار اسم الحساب"
            Return
        End If
        ...
        If DT.Rows.Count >= 0 Then
            ...
            PR111(0) = New SqlParameter("@AccID", SqlDbType.Int) With {.Value = AccID.EditValue}
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Try
            ...
            dt = RUN_QUARY_PRO("AccSafeActivityTb_GETPartnerMOVEMENT", PRM)
            If dt.Rows.Count > 0 Then
                Dim report As New RPT_AccountStatement
                report.DataSource = dt
                report.DataMember = "AccSafeActivityTb_GETPartnerMOVEMENT"
                Dim tool As ReportPrintTool = New ReportPrintTool(report)
                report.D1.Text = Format(D1.EditValue, "yyyy/MM/dd").ToString
                report.D2.Text = Format(D2.EditValue, "yyyy/MM/dd").ToString
                report.XrLabel4.Text = BrancID.Text
                report.XrLabel25.Text = AccID.Text
                report.XrLabel13.Text = GetUserName
                report.OverAllTotal1.Text = OverAllPeroid.Text
                report.XrLabel8.Text = OverAllNetTotal.Text
