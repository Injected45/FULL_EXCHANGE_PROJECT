...
Public Class FrmCustomerCurrBayAndSale
    Sub LOADCIDFROMT()
    ...
    Public Sub CurrencymovementPruse_FILLGRid()
        ...
        Dim dt As New DataTable
        dt.Clear()
        dt = RUN_QUARY_PRO("CurrencymovementCust_FILLGRid", prm)
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Try
            ...
            Dim dt As DataTable = RUN_QUARY_PRO("CurrencymovementCust_FILLGRid", PRM)
            If dt.Rows.Count > 0 Then
