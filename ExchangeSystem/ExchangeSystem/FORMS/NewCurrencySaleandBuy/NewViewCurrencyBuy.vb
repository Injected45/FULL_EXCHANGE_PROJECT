...
Public Class NewViewCurrencyBuy
    ...
    Sub LOADDATA()
        ...
        DT.Clear()
        DT = RUN_QUARY_PRO("New_CurrenciesBuyandsellTB_SelectAll", PRM)
        Dim DT1 As New DataTable
        DT1.Clear()
        DT1 = RUN_QUARY_PRO("New_CurrenciesBuyandsellTB_SelectAll2", PR)
    ...
    Private Sub GVRole_Click(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            Else
                FRMNEWCURRENCYSALE.GetRecord(CO)
            End If
        End If
        Me.Close()
    End Sub
