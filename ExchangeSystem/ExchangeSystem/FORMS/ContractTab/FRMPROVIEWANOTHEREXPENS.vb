...
Public Class FRMPROVIEWANOTHEREXPENS
    Public Sub LoadData()
        ...
        DT.Clear()
        DT = RUN_QUARY_PRO("[CONDB_PROANOTHEREXPENSTB_LOADTODVG]", PR)
    ...
    Private Sub GVRole_Click(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            FRMPROANOTHEREXPENS.IsUpdate = True
            FRMPROANOTHEREXPENS.SHOW_EMCUSCODE(CO)
            FRMPROANOTHEREXPENS.BtnSave.Enabled = False
            FRMPROANOTHEREXPENS.BtnDelete.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMPROANOTHEREXPENS.BtnEdit.Enabled = True
            FRMPROANOTHEREXPENS.BtnPrint.Enabled = True
            FRMPROANOTHEREXPENS.DISAPLEDCONTROLS()
            FRMPROANOTHEREXPENS.BtnEdit.Caption = "استرجاع القيمة"
        End If
        Me.Close()
    End Sub
End Class