...
Public Class FRMViewOroAsset
    Public Sub LoadData()
        GCRole.DataSource = Nothing
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_TXT("[CONDB_BayAseetTB_LOADTODVG]")
    ...
    Private Sub GVRole_Click(sender As Object, e As EventArgs) Handles GVRole.Click
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            FRMProBayAsset.IsUpdate = True
            FRMProBayAsset.SHOW_EMCUSCODE(CO)
            FRMProBayAsset.BtnSave.Enabled = False
            FRMProBayAsset.BtnDelete.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMProBayAsset.BtnEdit.Enabled = True
            FRMProBayAsset.BtnPrint.Enabled = True
            FRMProBayAsset.DISAPLEDCONTROLS()
            FRMProBayAsset.BtnEdit.Caption = "استرجاع القيمة"
        End If
        Me.Close()
    End Sub
End Class