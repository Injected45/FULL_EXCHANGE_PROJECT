...
Public Class FRMADDITEM
    ...
    Sub NEWRECORD()
        ...
        CodeID.Text = GETMAXID("ContractDB.dbo.ItemsTb", "ID") + 1
    ...
    Private Sub LSBOX_Click(sender As Object, e As EventArgs) Handles LSBOX.Click
        ...
        If DT.Rows.Count > 0 Then
            ...
            ExName.Text = DT.Rows(0)("ItemName").ToString
    ...
    Public Function EMPCSFT_Select(ID As Integer) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("CONDB_ItemsTb_SelectByID", PRM)
        Return DT
    End Function
    ...
    Public Sub EMPCSFT_INSERT()
        ...
        PRM(0) = New SqlParameter("@Code", SqlDbType.Int) With {.Value = CodeID.Text.Trim}
        PRM(1) = New SqlParameter("@ItemName", SqlDbType.NVarChar, -1) With {.Value = ExName.Text.Trim}
        ...
        RUN_EXUTE_PRO("CONDB_ItemsTb_Insert", PRM)
