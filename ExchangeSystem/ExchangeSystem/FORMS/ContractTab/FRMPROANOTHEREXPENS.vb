...
Public Class FRMPROANOTHEREXPENS
    ...
    Sub NEWRECORD()
        ...
        End If
        FrmScreensTb_Details_UESIRID_GETFrom(UserID, 141)
    End Sub
    ...
    Public Overrides Sub Print()
        ...
        Try
            ...
            Dim dt As DataTable = RUN_QUARY_PRO("CONDB_ZRPT_PettyCashTb_LOADTORPTANOTHEREXPENS", PRM)
            Dim ds As New DataSet
            dt.TableName = "ANOTHEREXPENSTB"
            ds.Tables.Add(dt)
            If dt.Rows.Count > 0 Then
                Dim report As New RPTPROANOTHEREXPENS
    ...
    Sub SHOW_EMCUSCODE(x)
        If Me.IsUpdate = True Then
            ...
            If DT.Rows.Count > 0 Then
                ...
                ProjectID.EditValue = DT.Rows(0)("AccIDPC")
                ExpensVal.EditValue = DT.Rows(0)("ExpensVal")
                AccIDEX.EditValue = DT.Rows(0)("ExID")
            End If
        End If
    End Sub
    Sub LOADBRANCH()
    ...
    Private Sub SimpleButton11_Click(sender As Object, e As EventArgs) Handles SimpleButton11.Click
        FRMPROVIEWANOTHEREXPENS.ShowDialog()
    End Sub
    ...
    Public Function ANOTHEREXPENSTB_MaxID(BranchID As Integer, SAFEID As ULong) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("[CONDB_ANOTHEREXPENSTB_MaxID]", PRM)
        Return DT
    End Function
    ...
    Public Sub ANOTHEREXPENSTB_Insert()
        ...
        Dim prm(16) As SqlParameter
            ...
            prm(6) = New SqlParameter("@AccIDEX", SqlDbType.BigInt) With {.Value = ProjectID.EditValue}
        ...
        prm(9) = New SqlParameter("@IsActive", SqlDbType.Bit) With {.Value = 1}
            prm(10) = New SqlParameter("@AccIDSafeID", SqlDbType.BigInt) With {.Value = SafeID.EditValue}
            ...
            prm(14) = New SqlParameter("@ExID", SqlDbType.Int) With {.Value = AccIDEX.EditValue}
            ...
            RUN_EXUTE_PRO("CONDB_ANOTHEREXPENSTB_Insert", prm)
            If IsUpdate = 0 Then
    ...
    Public Function SERACH_ANOTHEREXPENSTB(Code As String) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("[CONDB_ANOTHEREXPENSTB_SELECTByCODE]", PRM)
        Return DT
    End Function
End Class