...
Public Class FrmAddAssest
    ...
    Sub newRecord()
        Code.Text = GETMAXID("ContractDB.dbo.AddAssestTb", "ID") + 1
        ProName.Text = ""
        ProName.Focus()
        LOADBRANCH()
    ...
    Public Sub CUSTOMER_INSERT()
        Try
            ...
            PRM(1) = New SqlParameter("@AssestName", SqlDbType.NVarChar, -1) With {.Value = ProName.Text.Trim}
            ...
            PRM(8) = New SqlParameter("@AssestVal", SqlDbType.Decimal) With {.Value = AssestVal.EditValue}
            RUN_EXUTE_PRO("CONDB_AddAssestTb_Insert", PRM)
