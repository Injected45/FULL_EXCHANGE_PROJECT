...
Imports Microsoft
Public Class FrmSaleCurrency2026
    Public Type As Integer
    Dim IsUpdate As Int16
    Dim CurrPower As Int16
    ...
    Sub Newrecord()
        ...
        LoadToControlar(ThePurpose, "PurposeTB_LoadToLKP", "PName", "ID", Nothing)
        OwnBamkLoad()
        ...
        Code.Text = Type.ToString + "-" + (GETIDMAX_Pro("NewCurrencyBuyAndSale", "IDCode", 2, "BuyOrSale") + 1).ToString()
    ...
    Sub LoadAccIDFrom()
        ...
        If Not IsEmpty(BuyType) Then
            ...
            PR(2) = New SqlParameter("@SendOrRec", SqlDbType.TinyInt) With {.Value = If(TypeID.SelectedIndex = 1, 0, 1)}
    ...
    Private Sub PaymentType_EditValueChanged(sender As Object, e As EventArgs) Handles PaymentType.EditValueChanged
        ...
        If Not IsEmpty(PaymentType) Then
            ...
            PR(2) = New SqlParameter("@SendOrRec", SqlDbType.TinyInt) With {.Value = If(IsUpdate = False AndAlso SafeToInt(PaymentType.EditValue) <> 0, 0, 1)}
    ...
    Public Overrides Sub Print()
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                Dim report As New XtraReport_sell
    ...
    Sub LoadCurrncyTo()
        ...
        BuyPrice.EditValue = GetLKPColumnVal(CurrIDTo, "SalePrice")
    End Sub
    ...
    Sub GetNetTot()
        ...
        If GetLKPColumnVal(CurrIDTo, "CurrencyPower") = 0 Then
            PaymentVal.EditValue = Math.Ceiling((SafeToDecimal(BuyVal.EditValue) / SafeToDecimal(BuyPrice.EditValue)) / 5) * 5
            CurrPower = 0
        Else
            PaymentVal.EditValue = Math.Ceiling((SafeToDecimal(BuyVal.EditValue) * SafeToDecimal(BuyPrice.EditValue)) / 5) * 5
            CurrPower = 1
    ...
    Sub Insert_CurrencyBuySale()
        Try
            ...
            If Not ValidateControl(BuyVal, "القيمة المباعة") Then Exit Sub
            ...
            If BuyVal.EditValue <= 0 Then
                ErrorMessage(Me, "تنبية", "القيمة المباعة يجب أن تكون أكبر من صفر")
                Exit Sub
            End If
            '================= Parameters =================
            ...
            prm(2) = New SqlParameter("@BuyOrSale", SqlDbType.Int) With {.Value = 2} ' 2 شراء / 1 بيع
            ...
            prm(22) = New SqlParameter("@ThePurpose", SqlDbType.Int) With {.Value = SafeToInt(ThePurpose.EditValue)}
            ...
            prm(25) = New SqlParameter("@CurrPower", SqlDbType.Int) With {.Value = SafeToInt(CurrPower)}
            '================= Execute =================
    ...
    Public Overrides Sub UPDATERECORD()
        Try
            ...
            prm(1) = New SqlParameter("@BuyOrSale", SqlDbType.Int) With {.Value = 4} ' 4 استرجاع بيع
    ...
    Sub LoadToView()
        ...
        prm(2) = New SqlParameter("@BuyOrSale", SqlDbType.Int) With {.Value = 2}
