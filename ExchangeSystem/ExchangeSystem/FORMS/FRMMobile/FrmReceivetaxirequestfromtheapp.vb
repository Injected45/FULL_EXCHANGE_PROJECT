...
Public Class FrmReceivetaxirequestfromtheapp
    Sub DVGFormat()
    ...
    Private Sub FrmReceivetaxirequestfromtheapp_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DVGFormat()
    ...
    Public Sub GET_Deteels_fOr_taxe(DeliveryPlaceID As ULong)
        Try
            ...
            prm(1) = New SqlParameter("@ConfirmType", SqlDbType.Int) With {.Value = 7}
        ...
        End Try
    End Sub
    Private Async Sub MAplinke_Click(sender As Object, e As EventArgs) Handles MAplinke.Click
    ...
    Private Sub OkBtn_Click(sender As Object, e As EventArgs) Handles OkBtn.Click
       ...
       Not String.IsNullOrEmpty(clientName) Then
            ...
            'If MessageBox.Show("هل تريد فتح موقع العميل علي خرائط قوقل", "رسالة تنبيية", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            Dim customerMapLink As String = $"https://www.google.com/maps/dir/?api=1&origin={latitudeClient},{longitudeClient}&destination={longitudeBranch},{latitudeBranch}&travelmode=driving"
            FRM_OK_Taxie_Mobile.loddate(customerMapLink, GVRole.GetFocusedRowCellValue("Code"), GVRole.GetFocusedRowCellValue("OverallVal"),
GVRole.GetFocusedRowCellValue("RecievedName"), GVRole.GetFocusedRowCellValue("RPhone1"))
            FRM_OK_Taxie_Mobile.ShowDialog()
        End If
