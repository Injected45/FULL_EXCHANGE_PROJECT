...
Public Class FRmSandTaxiForMobile
    Sub DVGFormat()
    ...
    Private Sub FRmSandTaxiForMobile_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DVGFormat()
    ...
    Public Sub GET_Deteels_fOr_taxe(DeliveryPlaceID As ULong)
        Try
            ...
            prm(1) = New SqlParameter("@ConfirmType", SqlDbType.Int) With {.Value = 9}
    ...
    Private Sub Returnsfrom_Click(sender As Object, e As EventArgs) Handles Returnsfrom.Click
