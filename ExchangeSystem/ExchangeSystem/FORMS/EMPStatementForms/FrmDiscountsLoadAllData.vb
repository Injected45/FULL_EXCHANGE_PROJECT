...
Public Class FrmDiscountsLoadAllData
    Sub LOADDATA()
        ...
        DT.Clear()
        DT = RUN_QUARY_PRO("DiscountValTb_LoadAllData", PR)
    ...
    Private Sub GVRole_RowCellStyle(sender As Object, e As RowCellStyleEventArgs) Handles GVRole.RowCellStyle
        ...
        If e.Column.FieldName = "الحالة" Then
            ...
            If _length = "مستمر" Then
                e.Appearance.ForeColor = Color.White
                e.Appearance.BackColor = Color.Red
            End If
            If _length = "منتهي" Then
                e.Appearance.ForeColor = Color.White
    ...
    Sub Print()
        ...
        Try
            ...
            Dim dt As DataTable = RUN_QUARY_PRO("ZRPT_DiscountValTb_LoadAllData", PRM)
            Dim ds As New DataSet
            dt.TableName = "DiscountValTb"
            ds.Tables.Add(dt)
            If dt.Rows.Count > 0 Then
                Dim report As New RPTDiscountsLoadAllData
