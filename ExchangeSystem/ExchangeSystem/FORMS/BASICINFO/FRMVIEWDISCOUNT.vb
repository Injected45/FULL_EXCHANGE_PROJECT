...
Public Class FRMVIEWDISCOUNT
    Public Sub LoadData()
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_TXT("DiscountTypeTb_LOADTODVG")
        If DT.Rows.Count > 0 Then
            GCRole.DataSource = DT
            GVRole.Columns("ID").Caption = "الرقم"
            GVRole.Columns("DISNAME").Caption = "الاسم"
    ...
    End Sub
    Private Sub FRMVIEWDISCOUNT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GVRole_DoubleClick(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            Dim CO As String = view.GetFocusedRowCellValue("DISNAME").ToString
            FRMADDDISCOUNTTYPE.IsUpdate = True
            FRMADDDISCOUNTTYPE.BtnSave.Enabled = False
            FRMADDDISCOUNTTYPE.BtnEdit.Enabled = True
            FRMADDDISCOUNTTYPE.BtnPrint.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMADDDISCOUNTTYPE.BtnDelete.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            FRMADDDISCOUNTTYPE.SHOW_REC(CO)
        End If
        Me.Close()
    End Sub
End Class