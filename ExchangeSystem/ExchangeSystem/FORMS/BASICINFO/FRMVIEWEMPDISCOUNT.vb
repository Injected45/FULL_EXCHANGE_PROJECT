...
Public Class FRMVIEWEMPDISCOUNT
    Public Sub LoadData()
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_TXT("DiscountValTb_LOADTODVG")
    ...
    Private Sub FRMVIEWEMPDISCOUNT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GVRole_DoubleClick(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            ...
            FRMEMPDISCOUNT.IsUpdate = True
            FRMEMPDISCOUNT.DISAPLEDCONTROLS()
            FRMEMPDISCOUNT.BtnSave.Enabled = False
            FRMEMPDISCOUNT.BtnEdit.Enabled = True
            FRMEMPDISCOUNT.BtnPrint.Enabled = True
            FRMEMPDISCOUNT.BtnEdit.Caption = "إلغاء قيمة الخصم"
            FRMEMPDISCOUNT.BtnPrint.Enabled = True
            FRMEMPDISCOUNT.BtnDelete.Visibility = False
            FRMEMPDISCOUNT.SHOW_RECORD(CO)
        End If
        Me.Close()
    End Sub
End Class