...
Public Class FRMViewADDPARTNER
    Sub LOADDATA()
        GCRole.DataSource = Nothing
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO_ONLY("AddPartnerTb_LoadAllToDVG")
    ...
    Private Sub GVRole_Click(sender As Object, e As EventArgs) Handles GVRole.DoubleClick
        ...
        If info.InRow OrElse info.InRowCell Then
            Dim roleId As Integer = Convert.ToInt32(view.GetFocusedRowCellValue("CurrentAcc"))
            FRMADDPARTENR.IsUpdate = True
            FRMADDPARTENR.BtnSave.Enabled = False
            FRMADDPARTENR.BtnEdit.Enabled = True
            FRMADDPARTENR.BtnDelete.Enabled = True
            FRMADDPARTENR.Show_CreditAccount(roleId)
            Me.Close()
        End If
    End Sub
