...
Public Class FRMEmployeeClassification
    Public IsUpdate As Boolean
    Dim cu As New EMPCSFT
    ...
    Sub NEWRECORD()
        ...
        CodeID.Text = GETMAXID("EmployeeClassificationTb", "ID") + 1
        LOADDATA()
    ...
    Private Sub LSBOX_Click(sender As Object, e As EventArgs) Handles LSBOX.Click
        For I As Integer = 0 To LSBOX.Items.Count - 1
            ...
            If DT.Rows.Count > 0 Then
                ...
                BtnPrint.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
                ECNAME.Text = DT.Rows(0)("ECNAME").ToString
    ...
    Private Sub FRMEmployeeClassification_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        lodePreportes()
        NEWRECORD()
    End Sub
End Class
Public Class EMPCSFT
    Public Function EMPCSFT_Select(ID As Integer) As DataTable
        ...
        Dim DT As New DataTable
        DT.Clear()
        DT = RUN_QUARY_PRO("EmployeeClassificationTb_SelectByID", PRM)
        Return DT
    End Function
    Public Function EMPCSFT_SelectAll() As DataTable
        ...
        Return DT
    End Function
    Public Sub EMPCSFT_INSERT(ECNAME As String, ID As Integer, IsUpdate As Boolean)
        Dim PRM(2) As SqlParameter
        PRM(0) = New SqlParameter("@ECNAME", SqlDbType.NVarChar, -1) With {.Value = ECNAME}
        PRM(1) = New SqlParameter("@ID", SqlDbType.Int) With {.Value = ID}
        PRM(2) = New SqlParameter("@IsUpdate", SqlDbType.Bit) With {.Value = IsUpdate}
        RUN_EXUTE_PRO("EmployeeClassificationTb_Insert", PRM)
    End Sub
