...
void main() {
  ...
  group('Fmt.stamp', () {
    test('يحذف كسور الثانية ويُبقي الساعة والدقيقة والثانية', () {
      expect(Fmt.stamp('2026-08-31 08:26:56.780'), '2026-08-31 08:26:56');
      expect(Fmt.stamp('2026-08-31T08:26:56.780'), '2026-08-31 08:26:56');
    });

    test('ما لا كسور فيه يمرّ كما هو', () {
      expect(Fmt.stamp('2026-08-31 08:26:56'), '2026-08-31 08:26:56');
      expect(Fmt.stamp('2026-08-31'), '2026-08-31');
    });

    test('الفاصل الأوسع للفاتورة', () {
      expect(Fmt.stamp('2026-08-31 08:26:56.780', separator: '    '),
          '2026-08-31    08:26:56');
      // تاريخ بلا وقت: لا شيء يُفصل، فلا تُقحَم مسافات في آخره.
      expect(Fmt.stamp('2026-08-31', separator: '    '), '2026-08-31');
    });

    test('الفارغ والفاضي', () {
      expect(Fmt.stamp(null), '');
      expect(Fmt.stamp('   '), '');
    });
  });
}
