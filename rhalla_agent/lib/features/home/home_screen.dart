  ...
  Widget build(BuildContext context) {
    ...
    return GlassRow(
      ...
      children: [
        ...
        SizedBox(
          /*
           * ⚠ 66 لا 54: الوسمُ الأطول اليوم «غير مسلَّمة» (كان «بانتظار
           * التسليم» فكان 74)، ولا يُقصّ.
           *
           * ولا يُترك 74: عرضٌ أوسع من أطول كلمةٍ يُبعد الأيقونةَ عن نصّها
           * ويُنقص ما يبقى للمبلغ في صفٍّ ضيّق.
           */
          width: 66,
          child: Column(
