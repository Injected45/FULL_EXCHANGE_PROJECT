...
class _EmployeeHomeScreenState extends ConsumerState<EmployeeHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tiles = <Widget>[
      ...
      /*
       * ⚠ الخزينةُ عادت — تصحيحُ المالك (10 سبتمبر 2026): إيقافُ العهدة
       * والوردية لم يكن يعني إخفاءَها. وهي هنا **مالُ حوالاته**: ما قبضه ممّا
       * أنشأ، وما دفعه فيما سلّم، والفرقُ — ليجرد الدرجَ ويطابق.
       *
       * وبنفس صلاحية «حوالاتي»: هذه هي هي، منظوراً إليها من جهة النقد.
       */
      if (p.can('VIEW_OWN_TRANSFERS'))
        _Tile(
          icon: Icons.savings_outlined,
          title: 'خزينتي',
          subtitle: 'المفترض في درجك، وحركة المال',
