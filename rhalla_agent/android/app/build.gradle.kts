...
android {
    ...
    buildTypes {
        release {
            ...
            // تقليص شيفرة جافا/كوتلن ومواردها في نسخة الإصدار.
            //
            // شيفرة دارت مُقلَّصة أصلاً بالترجمة المسبقة، أما جانب أندرويد
            // (المحرّك والإضافات) فيبقى كاملاً بلا هذا. والمكسب في
            // classes.dex والموارد وحدهما — ولا يمسّ المكتبات الأصلية.
            //
            // ⚠ يحتاج تحقّقاً بتشغيل نسخة إصدار فعلية: R8 يحذف ما لا يراه
            // مستعملاً، وما يُستدعى بالانعكاس قد يسقط. قواعد الإضافات تأتي
            // معها، وقواعد المحرّك يضيفها ملحق فلاتر.
